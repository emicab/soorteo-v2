const CheckVerified = ({ verified }) => {
  return (
    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="currentColor"  className={`w-4 h-4 rounded-full ${
        verified ? "text-blue-500" : "text-gray-300"
